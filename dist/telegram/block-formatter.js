import { err, ok } from "./block-state.js";
...
export function placeholderForKind(kind, meta = {}) {
    if (kind === "reasoning")
        return "🧠 <blockquote expandable>…</blockquote>";
    if (kind === "tool_call")
        return `🔧 <b>${escapeTelegramHtml(meta.toolName || "tool")}</b>\n<pre><code class=\"language-json\">…</code></pre>`;
    if (kind === "tool_result")
        return "📤 <pre>…</pre>";
    return "…";
}
export function formatBlock(kind, meta, buffer, streaming) {
