...
async function inspectJsonEndpoint(url: string): Promise<{ ok: boolean; status?: number; body?: any; error?: string }> {
  try {
...
async function buildGatewayDoctorReport(): Promise<string[]> {
  const cfg = getConfig();
